...
{
   TEST_ASSERT_EQUAL(actual.possible, expected.possible);

   if (expected.possible) {
      TEST_ASSERT_EQUAL(actual.move_count, expected.move_count);
      TEST_ASSERT_EQUAL(actual.goal_bucket, expected.goal_bucket);
      TEST_ASSERT_EQUAL(actual.other_bucket_volume,
                        expected.other_bucket_volume);
   }
}
...
static void
   ...
   bucket_result_t expected = {.possible = true,.move_count = 4,.goal_bucket =
          bucket_id_1,.other_bucket_volume = 5
   };
...
static void
   ...
   bucket_result_t expected = {.possible = true,.move_count = 8,.goal_bucket =
          bucket_id_2,.other_bucket_volume = 3
   };
...
static void
   ...
   bucket_result_t expected = {.possible = true,.move_count = 14,.goal_bucket =
          bucket_id_1,.other_bucket_volume = 11
   };
...
static void
   ...
   bucket_result_t expected = {.possible = true,.move_count = 18,.goal_bucket =
          bucket_id_2,.other_bucket_volume = 7
   };
...
static void
   ...
   bucket_result_t expected = {.possible = true,.move_count = 1,.goal_bucket =
          bucket_id_2,.other_bucket_volume = 0
   };
...
static void
   ...
   bucket_result_t expected = {.possible = true,.move_count = 2,.goal_bucket =
          bucket_id_2,.other_bucket_volume = 2
   };
...
int main(void)
{
   UnityBegin("test/test_two_bucket.c");
